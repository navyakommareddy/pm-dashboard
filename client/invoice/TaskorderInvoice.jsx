...
class TaskorderInvoice extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            open: false,
    ...
    handleAdd = (e, id) => {
        ...
        axios.post('http://localhost:2305/taskorderinvoice/add', body, header)
            .then((res) => {
    ...
    render() {
        ...
        return (
            <Modal className="scrolling"
                ...
                size="small">
                <Modal.Header>Taskorder Invoice</Modal.Header>
                <Modal.Content>
                    <Modal.Description>
...
export default TaskorderInvoice;